...
document.querySelector("#autocompletionCom").style.height = `${3 * 5}vh`;
document.querySelector("#autocompletionCom").style.display = `block`;

document.querySelector("#autocompletionCom").innerHTML = `<div id="autoItemCom"><div class="autoItemCom">BEN</div></div>`;
document.querySelector("#autocompletionCom").innerHTML = `<div id="autoItemCom"><div class="autoItemCom">JA</div></div>`;
document.querySelector("#autocompletionCom").innerHTML = `<div id="autoItemCom"><div class="autoItemCom">MIN</div></div>`;

document.querySelector("#autocompletionAni").style.height = `${3 * 5}vh`;
document.querySelector("#autocompletionAni").style.display = `block`;

document.querySelector("#autocompletionAni").innerHTML = `<div id="autoItemAni"><div class="autoItemAni">BEN</div></div>`;
document.querySelector("#autocompletionAni").innerHTML = `<div id="autoItemAni"><div class="autoItemAni">JA</div></div>`;
document.querySelector("#autocompletionAni").innerHTML = `<div id="autoItemAni"><div class="autoItemAni">MIN</div></div>`;
